...
//}
//
//class Wage_Employee extends Employee_New {
//    int hrs, rate;
...
//        Employee_New sales = new Sales_Person(employee_id, employee_name, emp_time, emp_amount, sales_name, sales_no, sales_amount);
//        sales.computesalary();
//        Employee_New manager = new Manager(manager_name, manager_salary, manager_incentives);
//        manager.computesalary();
//
//
//        //
//
//        Employee_New[] emp =new Employee_New[4];
//        emp[0]=new Employee_New(101,"Usman");
//        emp[1]=new Employee_New(102,"Jaish");
//        emp[2]=new Employee_New(103,"Zulfa");
//        emp[3]=new Employee_New(104,"Arti");
//
//
